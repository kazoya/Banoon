...
export const metadata: Metadata = {
  ...
  title: {
    default: `${siteConfig.nameAr} | تصور مبيعات المدارس`,
    template: `%s | ${siteConfig.nameAr}`,
  },
  description:
    "تصور أولي مستقل لمنصة مبيعات ومسابقات مدارس لعلامة بنون كيدز التابعة لشركة دلتا للصناعات البلاستيكية. ليس نظاماً رسمياً للشركة.",
